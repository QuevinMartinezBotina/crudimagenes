    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <form class="p-2" action="{{ route('productos.update', ['producto' => $producto->id]) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input name="nombre" type="text" class="form-control" id="exampleInputEmail1"
                            aria-describedby="emailHelp" value="{{ $producto->nombre }}">
                    </div>

                    <div class="mb-3">
                        <label for="descripcion" class="form-label">Descripción</label>
                        <input name="descripcion" type="text" class="form-control" id="exampleInputEmail1"
                            aria-describedby="emailHelp" value="{{ $producto->descripcion }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <img class="w-50 img-fluid" src="/imagen/{{ $producto->imagen }}" id="imagenSeleccionada">
                    </div>
